...
function FireWeaponPlayerAndNPC( WeaponPrimaryAttackParams attackParams, bool playerFired, entity weapon )
{
	...
	{
		FireWeaponPlayerAndNPC_Original( attackParams, playerFired, weapon );
	}
}
...
function FireWeaponPlayerAndNPC_Original( WeaponPrimaryAttackParams attackParams, bool playerFired, entity weapon )
{
