...
void function UpdateCachedLoadouts()
{
		...
		printt( "initializedVersion: ", player.GetPersistentVarAsInt( "initializedVersion" ) )
		while ( player.GetPersistentVarAsInt( "initializedVersion" ) < PERSISTENCE_INIT_VERSION )
		{
			printt( "initializedVersion: ", player.GetPersistentVarAsInt( "initializedVersion" ) )
			WaitFrame()
		}
		printt( "FINAL initializedVersion: ", player.GetPersistentVarAsInt( "initializedVersion" ) )
