global function ModelPicker_Client_Init;
...
void function ModelPicker_Client_Init()
{
	...
	RegisterButtonPressedCallback( KEY_0, KeyPress_ModelPicker_KEY_PAD_0 );
	RegisterButtonPressedCallback( KEY_1, KeyPress_ModelPicker_KEY_PAD_1 );
	RegisterButtonPressedCallback( KEY_2, KeyPress_ModelPicker_KEY_PAD_2 );
	RegisterButtonPressedCallback( KEY_3, KeyPress_ModelPicker_KEY_PAD_3 );
	RegisterButtonPressedCallback( KEY_4, KeyPress_ModelPicker_KEY_PAD_4 );
	RegisterButtonPressedCallback( KEY_5, KeyPress_ModelPicker_KEY_PAD_5 );
	RegisterButtonPressedCallback( KEY_6, KeyPress_ModelPicker_KEY_PAD_6 );
	RegisterButtonPressedCallback( KEY_7, KeyPress_ModelPicker_KEY_PAD_7 );
	RegisterButtonPressedCallback( KEY_8, KeyPress_ModelPicker_KEY_PAD_8 );
	RegisterButtonPressedCallback( KEY_9, KeyPress_ModelPicker_KEY_PAD_9 );
